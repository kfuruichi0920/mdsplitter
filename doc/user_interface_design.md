...
2. **トレーサビリティグループ** (左寄せ)
   ...
   - 選択中カードトレースフィルタ(🧐アイコン) ※トグルボタン、選択パネルかつ選択カードとトレーサビリティ関係のカードのみを表示するフィルタ。複数パネルがあり、トレーサビリティ関係が数珠繋ぎとなる場合は、その関係するカードも含む。
...
- `🧐`（選択中カードトレースフィルタ）が ON の場合、トレーサビリティ経路上のカードのみを各パネルに表示する。OFF の場合は全カードを表示し、関係カードのみハイライトする。
