...
2. **トレーサビリティグループ** (左寄せ)
   ...
   - トレース表示切替のトレース関係種別(ドロップダウンとし、それぞれON/OFF選択可能とする)
   - トレース作成のトレース関係種別(ドロップダウン)
   - 選択中カード(🧐アイコン) ※トグルボタン、選択パネルかつ選択カードとトレーサビリティ関係のカードのみを表示するフィルタ。複数パネルがあり、トレーサビリティ関係が数珠繋ぎとなる場合は、その関係するカードも含む。
   - トレースタイプフィルタ (🧬アイコン)
...
3. **コネクタグループ**
   - トレース表示切替 (⛓️アイコン) ※トグルボタン、当該カードファイルカードに全カード対するコネクタ表示有無を切り替える。
