...
```
【基盤機能層】← 他の機能が依存する土台
├─ 4. ID自動付与 (cardIdフィールド追加)
│   └─ 影響範囲: 2, 5, 7, 9, 11, 12
└─ 10. 廃止ステータス (CardStatus型拡張)
    └─ 影響範囲: 1, 2, 5, 9
