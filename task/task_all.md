...
- [ ] P2-05a 上下分割ボタン、左右分割ボタンによるカードパネルエリアの分割操作を実装し、分割がキーボード操作で動作することをUIテストで確認する。
- [ ] P2-05b 上下分割、左右分割の境界をドラッグアンドドロップすることで、カードパネルエリアの分割領域を任意のサイズに調整できる機能を実装し、UIテストで確認する。
...
- [ ] P2-12 カードパネルの分割管理ストアを設計し、左右/上下分割状態・分割ヒストリのデータモデルを実装する。
- [ ] P2-13 カードパネル UI へ分割レイアウトコンテナを導入し、分割操作 (左右/上下)・分割解除を実装する。
- [ ] P2-14 各分割パネルが独立したカードビューを保持できるよう連携し、タブ/フィルタ/カード操作が同期する仕組みを整備する。
- [ ] P2-15 左右分割したパネル間でトレーサビリティコネクタを描画する UI を実装し、仮データで接続表示を確認する。
